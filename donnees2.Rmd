...
date: "`r Sys.Date()`"
lang: fr
institute: "Réanimation médico-chirurgicale - USRC"
output:
...
- Données sécurisées
- Base centralisée, accessible à tous
...
```{r}
tabcph(tt,esc, c(5:10,30),nomv = names(tt), nomvar = "Escarre")
```
...
- .lg[**les menteurs**]
- .lg[**les fieffés menteurs**]
- .lg[** *&* les .red[statisticiens]**]
